...
def logo_taekyung():
    try:
        os.system("xdg-open https://instagram.com/_julyoputra.king?igshid=OGQ5ZDc2ODk2ZA==")
        time.sleep(3)
        os.system("clear")
        print(f"""
...
\033[1;91m\033[1;41m\033[1;97m Author: JxL YBae\033[;0m\033[1;91m\033[1;92m
""")
    ...
    try:
        ...
        for i in range(int(power_python)):
            ...
            if "call" in jag:
                ...
                mengetik(f"{W}[{R}×{W}] Gagal Mengirim Spam Y {Y}{mr_am}")
            time.sleep(1)
        ...
        sys.exit(f"{W}[{Y}!{W}] Lu jangan asal masukin jamal{abu}.....")
